...
def isolate(name: str) -> Callable[[Callable[..., dict]], Callable[..., dict]]:
    ...
    This is the one place a broad except is correct: the handler converts any
    failure into a typed pipeline outcome rather than swallowing it - the reason
    is preserved and surfaced."""
