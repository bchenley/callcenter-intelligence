...
# Whisper hallucinates boilerplate on silence and low-quality audio. These are the
# artifacts the spec names; each is removed rather than trusted as speech.
...
def _segment_confidence(avg_logprob: float, no_speech_prob: float) -> float:
    ...
    sure the VAD was that this was speech at all. Weighted 0.7/0.3 per the spec."""
