...
@pytest.fixture
def engine(tmp_path):
    """A file-backed SQLite database per test under tmp_path. A file rather than
    :memory: so the test exercises the same path-creation and connection
    behaviour the app uses."""
